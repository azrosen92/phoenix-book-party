defmodule BookParty.PartyControllerTest do
  use BookParty.ConnCase
  ...
  test "creates resource and redirects when data is valid", %{conn: conn} do
    @valid_attrs = %{
      user_one: "test1@gmail.com",
      user_two: "test2@gmail.com",
      user_three: "test3@gmail.com",
      user_four: "test4@gmail.com",
      user_five: "test5@gmail.com",
      user_six: "test6@gmail.com"
    }
